...
/**
 * The InputFileTranslationMessageStatus enum defines the message status for the input file translation.
 * @author zc
 */
public enum InputFileTranslationMessageStatus {
    ...
    private InputFileTranslationMessageStatus(String message, boolean visible, Color color, boolean canBeProcessed) {
